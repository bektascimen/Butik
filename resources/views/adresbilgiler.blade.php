            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="contact-widget">
                        ...
                        <br>
                        <div>
                        <a href="{{route('adres.sil', ['id'=>$adres->id])}}" class="primary-btn" style="height: 45px;">Adresİ Sİl</a>
                        <a href="{{ route('adresguncelle', $adres->id) }}" class="primary-btn">&nbsp;SEÇİLİ ADRESİ GÜNCELLE</a>
                        </div>
                      </div><br>
                   @endforeach
                </div>
