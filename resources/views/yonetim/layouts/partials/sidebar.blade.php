<div class="list-group">
    ...
    <a href="{{route('yonetim.kullanici')}}" class="list-group-item">
        ...
        <span class="badge badge-dark badge-pill pull-right">
            {{ $istatistikler['toplam_kullanici'] }}
        </span>
    </a>
    ...
    <a href="#" class="list-group-item collapsed" data-target="#mnu_raporlar" data-toggle="collapse" data-parent="#sidebar">
        <span class="fa fa-fw fa-pie-chart"></span>Raporlar<span class="caret arrow"></span>
    </a>
